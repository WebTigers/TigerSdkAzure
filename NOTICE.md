...
**Tiger Azure PHP SDK** (`webtigers/tiger-sdk-azure`) is licensed MIT — see [LICENSE](LICENSE). "Tiger" and "WebTigers"
...
Tiger install can use Azure Blob Storage without running Composer. That bundled software keeps its own
license, which governs its use:

- **microsoft/azure-storage-blob** (MIT) — https://github.com/Azure/azure-storage-php
